...
export const lessonData = [
  {
    ...
    content: `
      <div class="text-center mb-6">
        <img  alt="Planeta Terra com um termômetro gigante mostrando alta temperatura e uma expressão preocupada." class="w-1/2 mx-auto rounded-lg shadow-lg" src="https://images.unsplash.com/photo-1700832082353-8d347b12efd5" />
      </div>
  ...
  },
  {
    ...
    content: `
      <div class="text-center mb-6">
        <img  alt="Uma pegada gigante feita de elementos da natureza (folhas, galhos) com uma lupa sobre ela." class="w-1/2 mx-auto rounded-lg shadow-lg" src="https://images.unsplash.com/photo-1600593832034-3215b5843fac" />
      </div>
  ...
  },
  {
    ...
    content: `
      <div class="text-center mb-6">
        <img  alt="Um sol sorridente, uma turbina eólica girando alegremente e painéis solares brilhando." class="w-2/3 mx-auto rounded-lg shadow-lg" src="https://images.unsplash.com/photo-1592833159091-10e59577d32f" />
      </div>
  ...
  },
  {
    ...
    content: `
      <div class="text-center mb-6">
        <img  alt="Crianças vestidas de detetives com lupas, investigando diferentes tipos de lixo reciclável." class="w-2/3 mx-auto rounded-lg shadow-lg" src="https://images.unsplash.com/photo-1666467126065-350247a9de50" />
      </div>
  ...
  },
  {
    ...
    content: `
      <div class="text-center mb-6">
        <img  alt="Gotas de água sorridentes com capas de super-heróis, protegendo um rio limpo." class="w-1/2 mx-auto rounded-lg shadow-lg" src="https://images.unsplash.com/photo-1658695122310-aeda67139957" />
      </div>
