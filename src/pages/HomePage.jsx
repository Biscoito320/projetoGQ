          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
                Sua jornada para um <span className="bg-gradient-to-r from-green-800 via-lime-400 to-yellow-400 bg-clip-text text-transparent font-bold">planeta mais saudável</span> começa aqui.
              </h1>
        ...
        <div className="container">
          ...
          >
            <motion.h2 variants={itemVariants} className="text-3xl md:text-4xl font-bold mb-4 text-foreground">
              Como o <span className="bg-gradient-to-r from-green-800 to-lime-400 bg-clip-text text-transparent font-bold">ClimaQuest</span> Funciona
            </motion.h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
                Nosso Foco: <span className="bg-gradient-to-r from-green-800 via-lime-400 to-yellow-400 bg-clip-text text-transparent font-bold">ODS 13.3</span>
              </h2>
            ...
            >
               <div className="rounded-3xl overflow-hidden soft-shadow border-4 border-background">
                <img src={imagemComunidade} alt="Descrição" />
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">
              Junte-se à nossa <span className="bg-gradient-to-r from-green-800 via-lime-400 to-yellow-400 bg-clip-text text-transparent font-bold">Comunidade</span>
            </h2>
